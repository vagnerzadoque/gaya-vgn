...
const meta: Meta<GayaButtonProps> = {
  ...
  // Definir argTypes explicitamente
  argTypes: {
...
export default meta
type Story = StoryObj<GayaButtonProps>

export const Playground: Story = {
  args: {
    children: 'button',
    onClick: fn() // Usar fn() em vez de () => null
  },
  render: (args: JSX.IntrinsicAttributes & (GayaButtonProps & React.RefAttributes<HTMLButtonElement>)) => <GayaButton {...args} />
}
...
export const Variants: Story = {
  ...
  render: (args: JSX.IntrinsicAttributes & (GayaButtonProps & React.RefAttributes<HTMLButtonElement>)) => (
    <StoryContainer>
...
export const LabelTransform: Story = {
  args: { 
    children: 'button',
    onClick: fn()
  },
